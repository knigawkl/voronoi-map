...
\tab Na \textit{Rysunku 1} przedstawiono prototypowy wygląd okna głównego programu. W górnej części okna znajduje się wąski pasek narzędzi, na którym umieszczono dwa przyciski. Kliknięcie pierwszego z nich otwiera eksplorator plików umożliwiający wybranie pliku tekstowego, z którego zostaną wczytane dane. Wybranie drugiego przycisku skutkuje otwarciem eksploratora umożliwiającego wybór pliku graficznego, który stanie się tłem dla planszy.
\\\tab Poniżej, w centrum okna głównego, znajduje się mapa terenu, na której wyświetlane mogą być kontury terenu, punkty kluczowe oraz obiekty. Na prawo od mapy umieszczono pionowy pasek narzędzi, na którym znajduje się szereg przycisków-przełączników. Każdy przycisk-przełącznik odpowiada jednemu z typów obiektów zadeklarowanych w pliku wejściowym. Znajduje się tam również przycisk-przełącznik symbolizujący kontur terenu.
